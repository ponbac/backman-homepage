    ...
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          ...
          luctus mi. Nunc sem massa, dictum eget sem sit amet, fringilla laoreet
          nisl. Vestibulum lectus ex,{' '}
          <NextLink href="/works">
            <Link>efficitur</Link>
          </NextLink>{' '}
          id condimentum et, semper ac risus. Aliquam a elementum tellus. Cras
          id fermentum nunc, vel porttitor sapien. Nullam in ornare dolor, vitae
          aliquam augue. Aliquam consectetur pellentesque efficitur. Sed
      ...
      <Section delay={0.3}>
        ...
        <Paragraph>
          ...
          sollicitudin nisl, sit amet accumsan quam eleifend vel. Aenean at
          luctus mi. Nunc sem massa, dictum eget sem sit amet, fringilla laoreet
          nisl. Vestibulum lectus ex, efficitur id condimentum et, semper ac
          risus. Aliquam a elementum tellus.
        </Paragraph>
      </Section>
    </Container>
  );
